...
export default function TopAppBar({ rightActions }: TopAppBarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-12 z-50 bg-surface-container-lowest/60 backdrop-blur-xl shadow-[0_12px_32px_rgba(40,223,181,0.08)] flex items-center justify-between px-4">
